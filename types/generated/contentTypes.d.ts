...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Content articles with rich body and SEO metadata';
    displayName: 'Article';
    pluralName: 'articles';
  ...
  attributes: {
    ...
    contentBlocks: Schema.Attribute.DynamicZone<
      ['shared.rich-text', 'shared.image-gallery', 'shared.cta', 'shared.faq']
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Content pages with layout blocks';
    displayName: 'Page';
    pluralName: 'pages';
    singularName: 'page';
  };
